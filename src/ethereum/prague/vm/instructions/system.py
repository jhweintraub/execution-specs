...
from ..storage import read_contiguous_slots, sload, tload
...
"""
    ...
    """
    # OPERATION
    evm.output = read_contiguous_storage(
        evm.memory
    )
...
def mreturn_(evm: Evm) -> None:
    """
    Halts execution returning output data from memory
